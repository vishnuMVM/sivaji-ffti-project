...
//   return (
//     <div className="w-full h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-10 overflow-y-auto">
...
//             <Card className="p-6 bg-white shadow-xl max-h-96 rounded-2xl transition-transform hover:scale-105">
...
//                 <Chip value={step.date} color="blue" className="rounded-full" />
//               </div>
//             </Card>
//           </div>
//         ))}
