       ...
       <div className="management-main-container">
           <div className="owner-container">
               ...
               <div className="mng-owner-info">
                   ...
                   <div className="para-icons-container">
                        <p className="para">Reddipalli Sivaji<br/>
                        One of the founder and CEO of FFTI sports wear and also for HCS SOLUTIONS company in USA,California.
                        He completed his B.Tech(Mechanical Engineering) from Osmania university, Hyderabad, Telangana. 
                        </p>
           ...
           <div className="owner-container">
               ...
               <div className="mng-owner-info-m">
                   <h2>Contact info</h2>
                   <div className="para-icons-container">
                        <p className="para">Chandagani Mahendra<br/>
                        One of the founder and CEO of FFTI sports wear and also for HCS SOLUTIONS company in USA,California.
                        He earned a master's level degree(MCA) as his highest academic level.
